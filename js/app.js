(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".card-product-thumbs__slider")) swiper1 = new core(".card-product-thumbs__slider", {
            ...
            if (document.querySelector(".related-product__slider")) new core(".related-product__slider", {
        ...
        if (filterCloseButton) filterCloseButton.addEventListener("click", function(e) {
            document.documentElement.classList.toggle("filter-open");
            bodyUnlock();
        });
        isWebp();
